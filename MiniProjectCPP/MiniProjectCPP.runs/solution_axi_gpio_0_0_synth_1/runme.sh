...
HD_PWD='C:/master/EmbeddedPRJ/MiniProjectCPP/MiniProjectCPP.runs/solution_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log solution_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source solution_axi_gpio_0_0.tcl
