...
HD_PWD='C:/master/EmbeddedPRJ/MiniProjectCPP/MiniProjectCPP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log solution_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source solution_wrapper.tcl
