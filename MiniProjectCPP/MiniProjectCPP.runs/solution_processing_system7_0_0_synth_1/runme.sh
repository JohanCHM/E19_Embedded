...
HD_PWD='C:/master/EmbeddedPRJ/MiniProjectCPP/MiniProjectCPP.runs/solution_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log solution_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source solution_processing_system7_0_0.tcl
