...
HD_PWD='C:/master/EmbeddedPRJ/MiniProjectCPP/MiniProjectCPP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log solution_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source solution_wrapper.tcl -notrace
