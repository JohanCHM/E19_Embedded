...
HD_PWD='C:/master/EmbeddedPRJ/MiniProjectCPP/MiniProjectCPP.runs/solution_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log solution_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source solution_xbar_0.tcl
