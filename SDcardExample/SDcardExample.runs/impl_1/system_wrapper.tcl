...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/master/Embedded/sandbox/SDcardExample/SDcardExample.cache/wt [current_project]
  set_property parent.project_path C:/master/Embedded/sandbox/SDcardExample/SDcardExample.xpr [current_project]
  set_property ip_repo_paths C:/master/Embedded/vivado-library-2016.4-1/vivado-library [current_project]
  set_property ip_output_repo C:/master/Embedded/sandbox/SDcardExample/SDcardExample.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES XPM_CDC [current_project]
  add_files -quiet C:/master/Embedded/sandbox/SDcardExample/SDcardExample.runs/synth_1/system_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files C:/master/Embedded/sandbox/SDcardExample/SDcardExample.srcs/sources_1/bd/system/system.bd
  set_property is_locked true [get_files C:/master/Embedded/sandbox/SDcardExample/SDcardExample.srcs/sources_1/bd/system/system.bd]
