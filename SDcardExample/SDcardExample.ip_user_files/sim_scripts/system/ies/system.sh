...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../SDcardExample.srcs/sources_1/bd/system/ipshared/7e3a/hdl" \
       +incdir+"$ref_dir/../../../../SDcardExample.srcs/sources_1/bd/system/ipshared/2ad9/hdl" \
       +incdir+"$ref_dir/../../../../SDcardExample.srcs/sources_1/bd/system/ipshared/39ca/hdl/verilog" \
       +incdir+"$ref_dir/../../../../SDcardExample.srcs/sources_1/bd/system/ipshared/6eb1/hdl" \
       +incdir+"$ref_dir/../../../../SDcardExample.srcs/sources_1/bd/system/ipshared/1d61/hdl" \
       +incdir+"../../../../SDcardExample.srcs/sources_1/bd/system/ipshared/7e3a/hdl" \
       +incdir+"../../../../SDcardExample.srcs/sources_1/bd/system/ipshared/2ad9/hdl" \
       +incdir+"../../../../SDcardExample.srcs/sources_1/bd/system/ipshared/39ca/hdl/verilog" \
       +incdir+"../../../../SDcardExample.srcs/sources_1/bd/system/ipshared/6eb1/hdl" \
       +incdir+"../../../../SDcardExample.srcs/sources_1/bd/system/ipshared/1d61/hdl"
}
