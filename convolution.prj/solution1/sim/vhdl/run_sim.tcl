...
if {[file isfile convolution.autotvin.dat]} {
	file delete -force convolution.autotvin.dat
}

if {[file isfile convolution.autotvout.dat]} {
	file delete -force convolution.autotvout.dat
}
