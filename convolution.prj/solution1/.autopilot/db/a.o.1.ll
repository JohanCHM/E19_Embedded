; ModuleID = 'C:/master/EmbeddedPRJ2/E19_Embedded/convolution.prj/solution1/.autopilot/db/a.g.1.bc'
...
; [#uses=0]
define void @convolution([3 x i32]* %k, [3 x i32]* %wdw, i32* %res) nounwind {
  call void (...)* @_ssdm_op_SpecTopModule([12 x i8]* @convolution.str) nounwind
  call void @llvm.dbg.value(metadata !{[3 x i32]* %k}, i64 0, metadata !2663), !dbg !2664 ; [debug line = 4:9] [debug variable = k]
  call void @llvm.dbg.value(metadata !{[3 x i32]* %wdw}, i64 0, metadata !2665), !dbg !2666 ; [debug line = 5:11] [debug variable = wdw]
  call void @llvm.dbg.value(metadata !{i32* %res}, i64 0, metadata !2667), !dbg !2668 ; [debug line = 6:15] [debug variable = res]
  call void (...)* @_ssdm_SpecArrayDimSize([3 x i32]* %k, i32 3) nounwind, !dbg !2669 ; [debug line = 7:2]
  call void (...)* @_ssdm_SpecArrayDimSize([3 x i32]* %wdw, i32 3) nounwind, !dbg !2671 ; [debug line = 7:30]
  store i32 0, i32* %res, align 4, !dbg !2672     ; [debug line = 9:5]
  br label %1, !dbg !2673                         ; [debug line = 10:24]

; <label>:1                                       ; preds = %5, %0
  %tmp = phi i32 [ 0, %0 ], [ %.lcssa, %5 ]       ; [#uses=1 type=i32]
  %i = phi i32 [ 0, %0 ], [ %i.1, %5 ]            ; [#uses=4 type=i32]
  %exitcond1 = icmp eq i32 %i, 3, !dbg !2673      ; [#uses=1 type=i1] [debug line = 10:24]
  br i1 %exitcond1, label %6, label %2, !dbg !2673 ; [debug line = 10:24]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !2675 ; [debug line = 11:6]
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !2675 ; [#uses=1 type=i32] [debug line = 11:6]
  %tmp.1 = sub nsw i32 2, %i, !dbg !2677          ; [#uses=1 type=i32] [debug line = 14:13]
  br label %3, !dbg !2680                         ; [debug line = 12:28]

; <label>:3                                       ; preds = %4, %2
  %tmp.2 = phi i32 [ %tmp, %2 ], [ %tmp.6, %4 ]   ; [#uses=2 type=i32]
  %j = phi i32 [ 0, %2 ], [ %j.1, %4 ]            ; [#uses=4 type=i32]
  %exitcond = icmp eq i32 %j, 3, !dbg !2680       ; [#uses=1 type=i1] [debug line = 12:28]
  br i1 %exitcond, label %5, label %4, !dbg !2680 ; [debug line = 12:28]

; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !2681 ; [debug line = 13:10]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !2681 ; [#uses=1 type=i32] [debug line = 13:10]
  %tmp.4 = sub nsw i32 2, %j, !dbg !2677          ; [#uses=1 type=i32] [debug line = 14:13]
  %k.addr = getelementptr inbounds [3 x i32]* %k, i32 %tmp.1, i32 %tmp.4, !dbg !2677 ; [#uses=1 type=i32*] [debug line = 14:13]
  %k.load = load i32* %k.addr, align 4, !dbg !2677 ; [#uses=2 type=i32] [debug line = 14:13]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %k.load) nounwind
  %wdw.addr = getelementptr inbounds [3 x i32]* %wdw, i32 %i, i32 %j, !dbg !2677 ; [#uses=1 type=i32*] [debug line = 14:13]
  %wdw.load = load i32* %wdw.addr, align 4, !dbg !2677 ; [#uses=2 type=i32] [debug line = 14:13]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %wdw.load) nounwind
  %tmp.5 = mul nsw i32 %wdw.load, %k.load, !dbg !2677 ; [#uses=1 type=i32] [debug line = 14:13]
  %tmp.6 = add nsw i32 %tmp.5, %tmp.2, !dbg !2677 ; [#uses=2 type=i32] [debug line = 14:13]
  store i32 %tmp.6, i32* %res, align 4, !dbg !2677 ; [debug line = 14:13]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i32 0), i32 %rbegin) nounwind, !dbg !2682 ; [#uses=0 type=i32] [debug line = 16:9]
  %j.1 = add nsw i32 %j, 1, !dbg !2683            ; [#uses=1 type=i32] [debug line = 12:37]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !2684), !dbg !2683 ; [debug line = 12:37] [debug variable = j]
  br label %3, !dbg !2683                         ; [debug line = 12:37]

; <label>:5                                       ; preds = %3
  %.lcssa = phi i32 [ %tmp.2, %3 ]                ; [#uses=1 type=i32]
  %rend3 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %rbegin2) nounwind, !dbg !2685 ; [#uses=0 type=i32] [debug line = 17:5]
  %i.1 = add nsw i32 %i, 1, !dbg !2686            ; [#uses=1 type=i32] [debug line = 10:33]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !2687), !dbg !2686 ; [debug line = 10:33] [debug variable = i]
  br label %1, !dbg !2686                         ; [debug line = 10:33]

; <label>:6                                       ; preds = %1
  ret void, !dbg !2688                            ; [debug line = 19:1]
}
...
!868 = metadata !{i32 786478, i32 0, metadata !869, metadata !"convolution", metadata !"convolution", metadata !"_Z11convolutionPA3_iS0_Ri", metadata !869, i32 3, metadata !870, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void ([3 x i32]*, [3 x i32]*, i32*)* @convolution, null, null, metadata !86, i32 7} ; [ DW_TAG_subprogram ]
...
!2656 = metadata !{void ([3 x i32]*, [3 x i32]*, i32*)* @convolution, metadata !2657, metadata !2658, metadata !2659, metadata !2660, metadata !2661, metadata !2662}
...
!2673 = metadata !{i32 10, i32 24, metadata !2674, null}
!2674 = metadata !{i32 786443, metadata !2670, i32 10, i32 10, metadata !869, i32 1} ; [ DW_TAG_lexical_block ]
!2675 = metadata !{i32 11, i32 6, metadata !2676, null}
!2676 = metadata !{i32 786443, metadata !2674, i32 11, i32 5, metadata !869, i32 2} ; [ DW_TAG_lexical_block ]
!2677 = metadata !{i32 14, i32 13, metadata !2678, null}
!2678 = metadata !{i32 786443, metadata !2679, i32 13, i32 9, metadata !869, i32 4} ; [ DW_TAG_lexical_block ]
!2679 = metadata !{i32 786443, metadata !2676, i32 12, i32 14, metadata !869, i32 3} ; [ DW_TAG_lexical_block ]
!2680 = metadata !{i32 12, i32 28, metadata !2679, null}
!2681 = metadata !{i32 13, i32 10, metadata !2678, null}
!2682 = metadata !{i32 16, i32 9, metadata !2678, null}
!2683 = metadata !{i32 12, i32 37, metadata !2679, null}
!2684 = metadata !{i32 786688, metadata !2679, metadata !"j", metadata !869, i32 12, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2685 = metadata !{i32 17, i32 5, metadata !2676, null}
!2686 = metadata !{i32 10, i32 33, metadata !2674, null}
!2687 = metadata !{i32 786688, metadata !2674, metadata !"i", metadata !869, i32 10, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2688 = metadata !{i32 19, i32 1, metadata !2670, null}
